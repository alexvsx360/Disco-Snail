...
const LEVEL_THEMES = [
  { bgGradient: ['#87ceeb','#5c94fc','#4a7fd8'], groundColor: '#5d4e37', blockStyle: 'brick', weather: 'sun', enemyTypes: ['turtle'], timeOfDay: 'day' },
  { bgGradient: ['#7dd3fc','#38bdf8','#0ea5e9'], groundColor: '#6b5b45', blockStyle: 'question', weather: 'sun', enemyTypes: ['turtle','fish'], timeOfDay: 'day' },
  { bgGradient: ['#93c5fd','#60a5fa','#3b82f6'], groundColor: '#5d4e37', blockStyle: 'brick', weather: 'cloudy', enemyTypes: ['turtle','fish','rat'], timeOfDay: 'day' },
  { bgGradient: ['#a5b4fc','#818cf8','#6366f1'], groundColor: '#6b5b45', blockStyle: 'brick', weather: 'cloudy', enemyTypes: ['turtle','fish','rat'], timeOfDay: 'night' },
  { bgGradient: ['#94a3b8','#64748b','#475569'], groundColor: '#57534e', blockStyle: 'brick', weather: 'wind', enemyTypes: ['turtle','fish','rat','spider'], timeOfDay: 'night' },
  { bgGradient: ['#cbd5e1','#94a3b8','#64748b'], groundColor: '#525252', blockStyle: 'brick', weather: 'wind', enemyTypes: ['turtle','fish','rat','spider'], timeOfDay: 'day' },
  { bgGradient: ['#bae6fd','#7dd3fc','#38bdf8'], groundColor: '#5d4e37', blockStyle: 'question', weather: 'rain', enemyTypes: ['turtle','fish','rat','spider'], timeOfDay: 'day' },
  { bgGradient: ['#1e3a5f','#0f2744','#0a1929'], groundColor: '#44403c', blockStyle: 'brick', weather: 'rain', enemyTypes: ['fish','rat','spider'], timeOfDay: 'night' },
  { bgGradient: ['#e2e8f0','#cbd5e1','#94a3b8'], groundColor: '#57534e', blockStyle: 'brick', weather: 'snow', enemyTypes: ['fish','rat','spider'], timeOfDay: 'day' },
  { bgGradient: ['#2d3748','#1a202c','#0d1117'], groundColor: '#44403c', blockStyle: 'brick', weather: 'snow', enemyTypes: ['fish','rat','spider'], timeOfDay: 'night' },
  { bgGradient: ['#64748b','#475569','#334155'], groundColor: '#3f3f46', blockStyle: 'brick', weather: 'rain', enemyTypes: ['rat','spider'], timeOfDay: 'night' },
  { bgGradient: ['#475569','#334155','#1e293b'], groundColor: '#3f3f46', blockStyle: 'brick', weather: 'wind', enemyTypes: ['rat','spider'], timeOfDay: 'night' },
  { bgGradient: ['#334155','#1e293b','#0f172a'], groundColor: '#27272a', blockStyle: 'brick', weather: 'snow', enemyTypes: ['rat','spider'], timeOfDay: 'day' },
  { bgGradient: ['#1e293b','#0f172a','#020617'], groundColor: '#27272a', blockStyle: 'brick', weather: 'rain', enemyTypes: ['rat','spider'], timeOfDay: 'night' },
  { bgGradient: ['#0f172a','#020617','#000000'], groundColor: '#18181b', blockStyle: 'brick', weather: 'snow', enemyTypes: ['rat','spider'], timeOfDay: 'night' }
];
